...
public:
  ...
  void AddLine(DebugShape& shape, const Vector3& start, const Vector3& end);
  void AddRay(DebugShape& shape, const Vector3& start, const Vector3& end, float t);
  void AddDisc(DebugShape& shape, const Vector3& center, const Vector3& discNormal, float radius);
  void AddDisc(DebugShape& shape, const Vector3& center, const Vector3& basis0, const Vector3& basis1, float radius);
  void AddSphereHorizonDisc(DebugShape& shape, const Vector3& sphereCenter, float sphereRadius);
  void AddQuad(DebugShape& shape, const Vector3& p0, const Vector3& p1, const Vector3& p2, const Vector3& p3);
  void AddArrowHead(DebugShape& shape, const Vector3& p, const Vector3& direction, float headSize);
