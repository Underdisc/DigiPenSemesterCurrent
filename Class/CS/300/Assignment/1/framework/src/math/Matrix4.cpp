...
namespace Math
{
  ...
  Matrix4 Matrix4::CreateProjection(float FOV, int width, int height, float zNear, float zFar)
  {
    ...
    mat.m00 = 1.29903805f; mat.m11 = 1.73205090f;
    mat.m22 = 1.00020003f; mat.m23 = -2.00020003f;
    mat.m32 = 1.0f;
    return mat;
  }
