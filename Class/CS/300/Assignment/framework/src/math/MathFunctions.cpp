...
namespace Math
{
  ...
  {
    // TODO(student): you will need to implement some method to convert from
    // EulerAngles to a Matrix3 or Matrix4; NOTE: you do NOT HAVE TO USE THE
    // EulerAngles PROVIDED WITH THE ZERO MATH FRAMEWORK. It is significantly
    // more complicated than what you need; feel free to rip it apart or just
