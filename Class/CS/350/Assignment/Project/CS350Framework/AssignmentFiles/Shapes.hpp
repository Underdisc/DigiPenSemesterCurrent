...
public:
  ...
  // Expand the Aabb on all 3 axes by an amount.
  void Expand(float amount);
  // Fatten the half extents of the aabb
  void Fatten(float factor);
...
public:
  ...
  // Create a plane from 3 points. The plane's normal should be normalized.
