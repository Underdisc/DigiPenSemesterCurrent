...
Matrix4::Matrix4(const float* data_)
{
...
{
  Matrix4& self = *this;
  ErrorIf(Math::DebugIsZero(rhs), "Matrix4 - Division by zero.");
  self[0] /= rhs;
  self[1] /= rhs;
  self[2] /= rhs;
  self[3] /= rhs;
...
Matrix4 Matrix4::Inverted() const
{
  ...
  ErrorIf(Math::DebugIsZero(determinant), "Matrix4 - Uninvertible matrix.");
...
Vector3 TransformDirection(Mat4Param matrix, Vec3Param normal)
{
